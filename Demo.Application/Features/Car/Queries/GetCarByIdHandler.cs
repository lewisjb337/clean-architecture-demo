...
public class GetCarByIdHandler : IHandler<GetCarByIdRequest, IList<CarResponse>>
{
    private readonly ApplicationDbContext _context;

    public GetCarByIdHandler(ApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<IList<CarResponse>> HandleAsync(GetCarByIdRequest request, CancellationToken cancellationToken)
    {
